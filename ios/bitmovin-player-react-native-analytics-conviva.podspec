...
Pod::Spec.new do |s|
  s.name           = 'bitmovin-player-react-native-analytics-conviva'
  ...
  s.source         = { git: 'https://github.com/bitmovin/bitmovin-player-react-native-analytics-conviva', :tag => "v#{s.version}" }
